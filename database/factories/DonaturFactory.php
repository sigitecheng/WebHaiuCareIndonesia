...
class DonaturFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'fundraising_id' => mt_rand(1, 8), // Assumes you have a Fundraising factory
            'total_amount' => $this->faker->numberBetween(1000, 100000), // Generates a random amount between 1000 and 100000
